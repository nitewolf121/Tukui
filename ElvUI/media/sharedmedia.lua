...
LSM:Register("font","NiteWolf Pixel Font", [[Interface\AddOns\ElvUI\media\fonts\Visitor_TT1_BRK.ttf]])
LSM:Register("font","Alt Pixel Font", [[Interface\AddOns\ElvUI\media\fonts\pf_ronda_seven.ttf]])
