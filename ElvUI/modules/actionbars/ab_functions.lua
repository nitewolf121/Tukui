...
function E.PositionAllPanels()
	...
	if C["actionbar"].bottompetbar ~= true then
		ElvuiActionBarBackground:SetPoint("BOTTOM", ElvuiBottomPanel, "TOP", 0, E.Scale(14))
		...
		ElvuiActionBarBackground:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, (E.buttonsize + (E.buttonspacing * 2)) + E.Scale(34))	
		...
		ElvuiLineToPetActionBarBackground:SetSize(265, 10)
