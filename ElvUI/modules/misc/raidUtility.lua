...
RaidUtilityPanel:CreatePanel("Transparent", E.Scale(230), panel_height, "TOP", E.UIParent, "TOP", -400, -5)
...
--Show Button
CreateButton("ShowButton", E.UIParent, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", 80, 18, "TOP", E.UIParent, "TOP", -400, -5, L.core_raidutil, nil)
