...
RaidUtilityPanel:CreatePanel("Transparent", E.Scale(230), panel_height, "TOP", ElvLocPanel, "BOTTOM", 0, -4)
...
--Show Button
CreateButton("ShowButton", UIParent, "UIMenuButtonStretchTemplate, SecureHandlerClickTemplate", 80, 21, "TOP", ElvLocPanel, "BOTTOM", 0, -4, L.core_raidutil, nil)
