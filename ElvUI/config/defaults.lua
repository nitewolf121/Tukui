...
DB["media"] = {
	...
	["datafont"] = "NiteWolfUI Font", -- general font of datatext
...
DB["unitframes"] = {
	...
	["powerclasscolor"] = false,             -- enable power color by class
...
DB["classtimer"] = {
	...
	["layout"] = 4, --1 - both player and target auras in one frame right above player frame, 2 - player and target auras separated into two frames above player frame, 3 - player, target and trinket auras separated into three frames above player frame, 4 - player and trinket auras are shown above player frame and target auras are shown above target frame, 5 - Everything above player frame, no target debuffs, 6 - Everything above target frame, no player debuffs or trinkets.
	["showspark"] = true,
	["cast_suparator"] = true,
...
DB["datatext"] = {
	["stat1"] = 13,						   -- Stat Based on your Role (Avoidance-Tank, AP-Melee, SP/HP-Caster)
	["dur"] = 3,                           -- show your equipment durability on panels.
	["stat2"] = 14, 						   -- Stat Based on your Role (Armor-Tank, Crit-Melee, Crit-Caster)
	["system"] = 8,                        -- show fps and ms on panels, and total addon memory in tooltip
	["wowtime"] = 9,                       -- show time on panels
	["gold"] = 10,                          -- show your current gold on panels
