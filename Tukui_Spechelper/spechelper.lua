...
spec:CreateShadow("Default")
	...
	if RaidBuffReminder then
		spec:SetPoint("TOPLEFT", ElvuiMinimapStatsLeft, "BOTTOMLEFT", 0, -16)
		spec:SetPoint("TOPRIGHT", RaidBuffReminder, "BOTTOMRIGHT", -23, -16)
	end	
	-- Text
	spec.t = spec:CreateFontString(spec, "OVERLAY")
	spec.t:SetPoint("CENTER")
	spec.t:SetFont(C["media"].datafont, C["datatext"].fontsize, "THINOUTLINE")
...
toggle:SetTemplate("Default", true)
toggle:CreateShadow("Default")
	...
	toggle:SetBackdropColor(unpack(C.general.color))
		...
		toggle.t:SetFont(C["media"].datafont, C["datatext"].fontsize, "THINOUTLINE")
...
dps:CreatePanel("Default", 30, 19, "TOPRIGHT", Toggle, "BOTTOMRIGHT", 0, -3)
dps:SetTemplate("Default", true)
dps:CreateShadow("Default")
dps:Hide()		
dps.t = dps:CreateFontString(nil, "OVERLAY")
dps.t:SetPoint("CENTER")
dps.t:SetFont(C["media"].datafont, C["datatext"].fontsize, "THINOUTLINE")
dps.t:SetText("DPS")
...
heal:CreatePanel("Default", 33, 19, "RIGHT", DPS, "LEFT", -3, 0)
heal:SetTemplate("Default", true)
heal:CreateShadow("Default")
		
heal.t = heal:CreateFontString(nil, "OVERLAY")
heal.t:SetPoint("CENTER")
heal.t:SetFont(C["media"].datafont, C["datatext"].fontsize, "THINOUTLINE")
heal.t:SetText("HEAL")
...
binds:CreatePanel("Default", 32, 19, "RIGHT", HEAL, "LEFT", -3, 0)
binds:SetTemplate("Default", true)
binds:CreateShadow("Default")

binds.t = binds:CreateFontString(nil, "OVERLAY")
binds.t:SetPoint("CENTER")
binds.t:SetFont(C["media"].datafont, C["datatext"].fontsize, "THINOUTLINE")
...
mui.t:SetFont(C["media"].datafont, C["datatext"].fontsize, "THINOUTLINE")
